...
class AsistenteReporteCompras(models.TransientModel):
    ...
    def print_report_excel(self):
        for w in self:
            ...
            hoja.write(y, 2, 'Numero Serie')
            hoja.write(y, 3, 'Numero de Factura')
            hoja.write(y, 4, 'Proveedor')
            hoja.write(y, 5, 'NIT')
            hoja.write(y, 6, 'Compras')
            hoja.write(y, 7, 'Compras exento')
            hoja.write(y, 8, 'Servicios')
            hoja.write(y, 9, 'Servicios exento')
            hoja.write(y, 10, 'Combustible')
            hoja.write(y, 11, 'Combustible exento')
            hoja.write(y, 12, 'Importaciones')
            hoja.write(y, 13, 'Pequeños contribuyentes')
            hoja.write(y, 14, 'IVA')
            ...
            for linea in lineas:
                ...
                hoja.write(y, 4, linea['proveedor']['name'])
                hoja.write(y, 5, linea['proveedor']['vat'])
                hoja.write(y, 6, linea['compra'])
                hoja.write(y, 7, linea['compra_exento'])
                hoja.write(y, 8, linea['servicio'])
                hoja.write(y, 9, linea['servicio_exento'])
                hoja.write(y, 10, linea['combustible'])
                hoja.write(y, 11, linea['combustible_exento'])
                hoja.write(y, 12, linea['importacion'] + linea['importacion_exento'])
                hoja.write(y, 13, linea['pequeño'] + linea['pequeño_exento'])
                hoja.write(y, 14, linea['iva'])
                hoja.write(y, 15, linea['total'])

            y += 1
            hoja.write(y, 4, 'Totales')
            hoja.write(y, 6, totales['compra']['neto'])
            hoja.write(y, 7, totales['compra']['exento'])
            hoja.write(y, 8, totales['servicio']['neto'])
            hoja.write(y, 9, totales['servicio']['exento'])
            hoja.write(y, 10, totales['combustible']['neto'])
            hoja.write(y, 11, totales['combustible']['exento'])
            hoja.write(y, 12, totales['importacion']['neto'] + totales['importacion']['exento'])
            hoja.write(y, 13, totales['pequeño']['neto'] + totales['pequeño']['exento'])
            hoja.write(y, 14, totales['compra']['iva'] + totales['servicio']['iva'] + totales['combustible']['iva'] + totales['importacion']['iva'] + totales['pequeño']['iva'])
            hoja.write(y, 15, totales['compra']['total'] + totales['servicio']['total'] + totales['combustible']['total'] + totales['importacion']['total'] + totales['pequeño']['total'])
